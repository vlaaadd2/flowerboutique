...
/** Хризантема. Додаткова властивість: колір пелюсток. */
public class Chrysanthemum extends Flower {
    ...
    public String getPetalColor() { return petalColor; }
    public void setPetalColor(String petalColor) { this.petalColor = petalColor; }
}